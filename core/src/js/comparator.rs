...
mod tests_comparator {
    ...
    fn test_loose_eq_num() {
        let mut tree = build_javascript_tree("var x = 42 == 42;").unwrap();
    ...
    fn test_loose_eq_str_num() {
        ...
        let mut tree = build_javascript_tree("var x = \"abc\" == 0;").unwrap();
        tree.apply_mut(&mut (
            ParseInt::default(),
            ParseString::default(),
            LooseEq::default(),
    ...
    fn test_loose_eq_bool_num() {
        let mut tree = build_javascript_tree("var x = true == 1;").unwrap();
        tree.apply_mut(&mut (
            ParseInt::default(),
            ParseBool::default(),
            LooseEq::default(),
        ...
        let mut tree = build_javascript_tree("var x = false == 0;").unwrap();
        tree.apply_mut(&mut (
            ParseInt::default(),
            ParseBool::default(),
            LooseEq::default(),
        ...
        let mut tree = build_javascript_tree("var x = true == 2;").unwrap();
        tree.apply_mut(&mut (
            ParseInt::default(),
            ParseBool::default(),
            LooseEq::default(),
    ...
    fn test_loose_eq_empty_str_num() {
        let mut tree = build_javascript_tree("var x = \"\" == 0;").unwrap();
        tree.apply_mut(&mut (
            ParseInt::default(),
            ParseString::default(),
            LooseEq::default(),
